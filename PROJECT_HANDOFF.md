...
8. Account baseline/contribution boundaries.
9. Complete wheel valuation/period reporting - will also be what promotes an ASSIGNED campaign's `currentPLStatus` from INCOMPLETE to CONFIRMED/PENDING (Ticket 4) and gives `assignedShareCapital` (Ticket 5) a real live valuation instead of cost basis only.
10. Dashboard hierarchy.
11. Settings/Admin + communication consolidation.
12. Scanner redesign/readability/mobile/history/benchmarks.
