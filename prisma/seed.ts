...
async function main() {
  ...
  const mattAccount = await prisma.tradingAccount.create({
    data: {
      ...
      manualBalance: "12076.00",
      visibility: "SHARED",
      snapshots: {
        create: {
          accountValue: "12076.00",
          cash: "9290.00",
          cashSecuringPuts: "3192.00",
          availableCash: "9290.00",
          realizedPL: "76.00",
          unrealizedPL: "21.00",
      ...
      ledgerEntries: {
        create: [
          { type: "STARTING_VALUE", occurredAt: new Date("2026-07-01T00:00:00Z"), amount: "10000.00", source: "MANUAL" },
          { type: "DEPOSIT", occurredAt: new Date("2026-08-10T00:00:00Z"), amount: "2000.00", source: "MANUAL", notes: "Demo contribution for contribution-adjusted performance math." },
        ],
      },
    },
  });
  ...
  const mattCorz = await prisma.watchlistItem.create({
    data: {
      ...
      ticker: "CORZ",
      status: "RESEARCHING",
      researchStatus: "NEUTRAL",
      companyName: "Core Scientific, Inc.",
      whatItDoes: "Bitcoin mining and AI/HPC data center infrastructure.",
      wouldOwn: "CONDITIONAL",
      wouldOwnMaxPrice: "14.00",
      visibility: "SHARED",
  ...
  await prisma.watchlistItem.create({
    data: {
      ...
      whatItDoes: "Trapped-ion quantum computing hardware and cloud access.",
  ...
  const ericSofi = await prisma.watchlistItem.create({
    data: {
      ...
      whatItDoes: "Digital consumer finance: lending, banking, and investing.",
      wouldOwn: "YES",
      visibility: "SHARED",
  ...
  await prisma.watchlistItem.create({
    data: {
      ...
      ticker: "AMD",
      status: "DO_NOT_TRADE",
      researchStatus: "NEVER_TRADE",
      exclusionReason: "Too cyclical/competitive for Eric's CSP comfort - demo Never Trade example.",
      visibility: "PRIVATE",
      tags: ["private"],
    },
  });
  ...
  await prisma.optionContractSnapshot.createMany({
    data: [
      {
        symbol: "CORZ 2026-09-18 P16.5",
        ...
        openInterest: 840,
        volume: 126,
        capturedAt: new Date("2026-08-29T14:45:00Z"),
      },
      {
        symbol: "IONQ 2026-09-18 P27",
        ...
        last: "0.1800",
        delta: "-0.2200",
        impliedVolatility: "0.6800",
        openInterest: 420,
        volume: 71,
        capturedAt: new Date("2026-08-29T14:45:00Z"),
      },
      {
        symbol: "AAP 2026-09-11 P39",
        ...
        last: "1.1500",
        delta: "-0.3400",
        impliedVolatility: "0.5900",
        openInterest: 310,
        volume: 42,
        capturedAt: new Date("2026-08-29T14:45:00Z"),
      },
      {
        symbol: "WBD 2026-09-18 P14",
        ...
        last: "0.1300",
        delta: "-0.2800",
        impliedVolatility: "0.5200",
        openInterest: 260,
        volume: 38,
        capturedAt: new Date("2026-08-29T14:45:00Z"),
      },
      {
        symbol: "HOOD 2026-09-18 P34",
